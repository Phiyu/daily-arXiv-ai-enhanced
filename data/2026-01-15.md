...
### [16] [Note on pulsar timing array correlation functions induced by peculiar velocities](https://arxiv.org/abs/2601.08915)
...
### [17] [A comparative test of different pressure profile models in clusters of galaxies using recent ACT data](https://arxiv.org/abs/2601.08933)
*Denis Tramonte*
...
### [18] [A possible pathway to UHZ1-type systems at z~10 by heterogeneous mass primordial black holes as dark matter](https://arxiv.org/abs/2601.08936)
...
### [19] [Bound Dark Energy: Particle Physics model in alignment with recent DESI cosmological measurements](https://arxiv.org/abs/2601.08943)
...
### [20] [Owl-z: a Bayesian tool to select z \geq 7 quasars](https://arxiv.org/abs/2601.09332)
...
### [21] [Time delay measurements with Broken Power Law model](https://arxiv.org/abs/2601.09369)
...
### [22] [Collapse versus Disruption: The Fate of Compact Stellar Systems in Ultralight Dark Matter Halos](https://arxiv.org/abs/2601.09403)
...
### [23] [Resolving Hubble tension and locating missing baryons: Synergies between fast radio bursts and emerging cosmological probes](https://arxiv.org/abs/2601.09521)
...
### [24] [A New Constraint on the Optical Depth from the Reionization History Independent of CMB Large-Scale E-Mode Polarization](https://arxiv.org/abs/2601.09644)
...
### [25] [Digging into the Interior of Hot Cores with ALMA. VI. The Formation of Low-mass Multiple Systems in High-mass Cluster-forming Regions](https://arxiv.org/abs/2601.08904)
...
### [26] [The miniJPAS survey: Dissecting galaxy properties across environments with spatially resolved photometry](https://arxiv.org/abs/2601.08911)
...
### [27] [Measuring the Vertical Structure of Active Galactic Nuclei Disks with Transformer Models and the Vera C. Rubin Observatory](https://arxiv.org/abs/2601.08926)
...
### [28] [Spinning compact object and chaos in galactic centers](https://arxiv.org/abs/2601.08937)
...
### [29] [Polarization echoes from past nuclear activity in the quasi-periodic eruption source GSN 069](https://arxiv.org/abs/2601.08940)
...
### [30] [The Quasar Feedback Survey: Revealing the importance of sensitive radio imaging for AGN identification deeper into the radio-quiet regime](https://arxiv.org/abs/2601.09218)
...
### [31] [The ALMaQUEST Survey XVII: Unveiling Multiple Quenching Pathways in Green Valley Galaxies via Molecular Gas and Quenching Timescale Analyses](https://arxiv.org/abs/2601.09225)
...
### [32] [New Estimate for the Cosmic Ray-Induced $\rm H_2$ Photodissociation Rate in the Interstellar Medium](https://arxiv.org/abs/2601.09387)
...
### [33] [Discovery of a new open cluster as a companion to Czernik 38 cluster and its associated complex tide, using Gaia DR3](https://arxiv.org/abs/2601.09670)
*Nasser M. Ahmed*
