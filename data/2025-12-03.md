...
### [12] [Search for Peak Structures in the Stochastic Gravitational-Wave Background in LIGO-Virgo-KAGRA O1-O4a Datasets](https://arxiv.org/abs/2512.01776)
...
### [13] [Realistic classical charge from an asymmetric wormhole](https://arxiv.org/abs/2512.00958)
...
### [14] [On extremal black holes](https://arxiv.org/abs/2512.01898)
...
### [15] [Imprints of Dark Matter on the Shadow and Polarization Images of a Black Hole Illuminated by Various Thick Disks](https://arxiv.org/abs/2512.00964)
...
### [16] [Quantum Recoherence in Presence of Excited States in the Early Universe](https://arxiv.org/abs/2512.01932)
...
### [17] [Kiselev Black Holes in Anti-de Sitter Spacetime Are Not Viable](https://arxiv.org/abs/2512.01265)
...
### [18] [A comprehensive analysis of Barrow holographic Chaplygin gas model reconstruction and its cosmological consequences](https://arxiv.org/abs/2512.01338)
...
### [19] [Accretion of Generalized Chaplygin Gas onto Cosmologically Coupled Black Holes](https://arxiv.org/abs/2512.01471)
...
### [20] [A Model-Independent Framework for Gravitational-Wave Reconstruction of Binary Black Hole Hyperbolic Encounters in Ground-Based Interferometers](https://arxiv.org/abs/2512.01476)
...
### [21] [Gravitational Memory Effect in the Massless Vector Field](https://arxiv.org/abs/2512.01578)
...
### [22] [Some considerations on BEC analogue black holes](https://arxiv.org/abs/2512.01613)
...
### [23] [Horizon Data: Existence Results and a Near-Horizon Equation on General Null Hypersurfaces](https://arxiv.org/abs/2512.01670)
...
### [24] [Gravitational lensing inside and outside of a marginally unstable photon sphere in a general, static, spherically symmetric, and asymptotically-flat spacetime in strong deflection limits](https://arxiv.org/abs/2512.01688)
*Naoki Tsukamoto*
...
### [25] [Quasinormal modes of Reissner-Nordström-AdS black holes under physical field-vanishing boundary conditions](https://arxiv.org/abs/2512.01694)
...
### [26] [Stellar Objects From Quantum Gravity](https://arxiv.org/abs/2512.01711)
...
### [27] [Cauchy data for multiple collapsing boson stars](https://arxiv.org/abs/2512.01844)
...
### [28] [Explicit and universal formula for thermodynamic volume in extended black hole thermodynamics](https://arxiv.org/abs/2512.01916)
...
### [29] [No Love for black holes: tightest constraints on tidal Love numbers of black holes from GW250114](https://arxiv.org/abs/2512.01918)
...
### [30] [The role of prompt cusps in driving the core collapse of SIDM halos](https://arxiv.org/abs/2512.00145)
...
### [31] [The ALMA Survey of 70 μm Dark High-mass Clumps in Early Stages (ASHES). XIII. Core Mass Function, Lifetime, and Growth of Prestellar Cores](https://arxiv.org/abs/2512.00147)
...
### [32] [The DREAMS Project: A New Suite of 1,024 Simulations to Contextualize the Milky Way and Assess Physics Uncertainties](https://arxiv.org/abs/2512.00148)
...
### [33] [Episodic Star Formation -- I. Overview and Scatter of the Star-Forming Main Sequence](https://arxiv.org/abs/2512.00151)
...
### [34] [CECILIA: The Mass-Metallicity Relation of Low-Mass Galaxies at Cosmic Noon](https://arxiv.org/abs/2512.00162)
...
### [35] [Recoiling Black Hole Candidates from Spatially Offset Broad Emission Lines in MaNGA](https://arxiv.org/abs/2512.00174)
...
### [36] [The sonic scale does not determine the core separation in turbulent molecular clouds](https://arxiv.org/abs/2512.00284)
...
### [37] [Uniformly-calibrated VPHAS+ photometry in the third quadrant of the Galactic plane](https://arxiv.org/abs/2512.00650)
...
### [38] [Evidence for the Faint-End Suppression in the z = 6 $\sim$ 8 UV Luminosity Function: A Lensing Analysis of Abell 2744](https://arxiv.org/abs/2512.00730)
*Xuheng Ma*
...
### [39] [Green Bean galaxies and the fading echoes of AGN activity](https://arxiv.org/abs/2512.00793)
...
### [40] [Investigating the Correlation between Dark Matter Content, Ages and Mass-to-Light Ratios in Spiral Galaxies](https://arxiv.org/abs/2512.00823)
...
### [41] [On the multiplicity of red-Herschel sources and its implications for extreme star formation](https://arxiv.org/abs/2512.00822)
...
### [42] [OzDES Reverberation Mapping of Active Galactic Nuclei: Final Data Release, Black-Hole Mass Results, & Scaling Relations](https://arxiv.org/abs/2512.01261)
...
### [43] [Possible quasi-periodic optical oscillations of ZTF blazars](https://arxiv.org/abs/2512.00871)
...
### [44] [OzDES Reverberation Mapping Program: CIV lags from six years of data](https://arxiv.org/abs/2512.01260)
...
### [45] [GASTRO library II: Exploring Chemical Bimodalities in Disk Galaxies with GSE-like Mergers and Massive Star-forming Clumps](https://arxiv.org/abs/2512.01293)
...
### [46] [The Milky Way stellar halo is twisted and doubly broken: insights from DESI DR2 Milky Way Survey observation](https://arxiv.org/abs/2512.01350)
...
### [47] [Discovery of a rich population of compact hub-filament systems in a single star-forming complex](https://arxiv.org/abs/2512.01455)
...
### [48] [Euclid: The first statistical census of dusty and massive objects in the ERO/Perseus field](https://arxiv.org/abs/2512.01489)
...
### [49] [The Hubble Missing Globular Cluster Survey. II. Survey membership tools and kinematic analysis of NGC 6749](https://arxiv.org/abs/2512.01530)
...
### [50] [Exploring the ultra-faint dwarf Bootes I using JWST and HST: Metallicity distribution and binaries](https://arxiv.org/abs/2512.01547)
...
### [51] [Searching for EeV photons with Telescope Array Surface Detector and neural networks](https://arxiv.org/abs/2512.01638)
...
### [52] [Transition from Outside-in to Inside-Out at $z\sim 2$: Evidence from Radial Profiles of Specific Star Formation Rate based on JWST/HST](https://arxiv.org/abs/2512.01684)
...
### [53] [First detections of methanol maser lines from a rare transition family](https://arxiv.org/abs/2512.01875)
...
### [54] [Weak, extended water vapor emission in the Horsehead nebula](https://arxiv.org/abs/2512.01901)
...
### [55] [JWST & the Waz Arc I: Spatially Resolving the Physical Conditions within a Post-Starburst Galaxy at Redshift 5 with NIRSpec IFS](https://arxiv.org/abs/2512.02000)
...
### [56] [Spatial Phonons: A Phenomenological Viscous Dark Energy Model for DESI](https://arxiv.org/abs/2512.00056)
...
### [57] [General-Relativistic Path Effects and the Local Hubble Expansion](https://arxiv.org/abs/2512.00067)
*Said Laaroua*
...
### [58] [Dynamical Heating from Dark Compact Objects and Axion Minihalos: Implications for the 21-cm Signal](https://arxiv.org/abs/2512.00169)
...
### [59] [Probing Fuzzy Dark Matter in the 21 cm Signal via Wavelet Scattering Transform](https://arxiv.org/abs/2512.00402)
...
### [60] [The SRG/eROSITA All-Sky Survey: A comprehensive X-ray analysis of the Hydra I galaxy cluster](https://arxiv.org/abs/2512.00518)
...
### [61] [Constraints on Chiral-Quintom dark energy after DESI DR2 and impact on unifying dark energy with inflation](https://arxiv.org/abs/2512.00558)
...
### [62] [Controlling weak-lensing shear biases from undetected galaxies in the era of Stage IV Surveys](https://arxiv.org/abs/2512.00666)
*Lisa M Voigt*
...
### [63] [Joint Constraints on Fuzzy and Warm Dark Matter from Satellite Populations of the Milky Way and Andromeda](https://arxiv.org/abs/2512.01361)
...
### [64] [Accurate cosmological emulator for the probability distribution function of gravitational lensing of point sources](https://arxiv.org/abs/2512.01607)
...
### [65] [Analytical Emulator for the Baryon EoM inside the Fuzzy Dark Matter Soliton from Machine Learning](https://arxiv.org/abs/2512.01622)
...
### [66] [Constraining Dark Acoustic Oscillations with the High-Redshift UV Luminosity Function](https://arxiv.org/abs/2512.01998)
